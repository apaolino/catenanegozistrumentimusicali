...
alter table `catalogo_categoria_prodotto`   add index fk_catalogo_categoria_prodot_2 (`catalogo_oid`), add constraint fk_catalogo_categoria_prodot_2 foreign key (`catalogo_oid`) references `catalogo` (`oid`);
alter table `catalogo_categoria_prodotto`   add index fk_catalogo_categoria_prodotto (`categoria_prodotto_oid`), add constraint fk_catalogo_categoria_prodotto foreign key (`categoria_prodotto_oid`) references `categoria_prodotto` (`oid`);
